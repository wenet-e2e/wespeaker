...
if __name__ == '__main__':
    ...
    parser.add_argument('--indomain_scp_path', type=str, help='embeddings to compute meanvec')
    parser.add_argument('--test_scp_path', type=str, help='test embeddings')
    parser.add_argument('--utt2spk', type=str, help='utt2spk for the enroll speakers')
